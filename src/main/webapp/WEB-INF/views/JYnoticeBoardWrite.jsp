...
<body>
	...
	<!-- 섹션 시작 -->
	<form action="JYnoticeBoardWrite.do" method="post" name="frm">
		<article class="article">
			<div class="article__notice-board-write">
				...
				<div class="notice-board-write__content">
					...
					<input type="hidden" name="bId" value="0"> <!-- 게시판 구분코드 공지사항 = 0 -->
					<input type="hidden" name="mId" value="admin"> <%-- ${jyPost.mId} --%>
