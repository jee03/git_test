        ...
        <article class="article">
            <div class="article__sharing-board-update">
                ...
                <div class="sharing-board-update__sort">
                    <select class="sharing-board-update__category" name="ctCode"  required >
                    ...
                    <select class="sharing-board-update__category category-status"
                        name="sharing-board-update__category--status" required>
                        ...
                        <div class="image--input-container">
                            <label class="image--input-label">
                                <div class="image--input-button button-3">
                                    <img
                                        src="https://pbs.twimg.com/media/DtEUNKNVAAE2rzu.jpg"
                                        alt="이미지3"/>
                                    <div class="del-btn"></div>
                                </div>
