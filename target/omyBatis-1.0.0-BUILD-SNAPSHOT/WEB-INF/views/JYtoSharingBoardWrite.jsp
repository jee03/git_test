        ...
        <article class="article">
            <div class="article__sharing-board-write">
                <div class="sharing-board-write__sort">
                    <select class="sharing-board-write__category"
                        name="ctCode" required>  <!-- name="sharing-board-write__category--code" -->
                ...
                <div class="sharing-board-write__content">
					...
					<input type="hidden" name="pStatus" value="1"> <!-- pStatus 거래 상태코드 1=거래중 -->
